# =============================================================================
# NOTE: This file is a direct copy of Katas/Kata4/pipeline.py.
# It is reproduced here so that Kata9's integration tests are self-contained
# and do not depend on a relative import from a sibling Kata directory.
# Any changes to the canonical pipeline should be made in Kata4 first.
# =============================================================================
